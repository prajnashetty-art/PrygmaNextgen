...
public class Help_and_support {
	  ...
	  public void reportSetup() {
	      ...
	      spark = new ExtentSparkReporter(projectPath + "/Reports/Help&support_Report.html");
	    ...
	    public void setup() throws InterruptedException {
	        ...
	        WebElement header = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(normalize-space(),'Help & Support')]")));
	    }
	    @Test(priority = 1)
	    ...
	    public void invalidemail() throws InterruptedException {
	    	...
	    	try {
				...
				Thread.sleep(2000);
	    		driver.findElement(By.id("name")).sendKeys(name);
				driver.findElement(By.id("email")).sendKeys("ge0833@ostahecom");
	    ...
	    public void FAquestion() throws InterruptedException {
	    	...
	    	try {
		    	...
		    	System.out.println("FAQ answer is not  visible after closing");
		    	test.pass("FAQ answer is not visible after closing");
	    	}catch(AssertionError e) {
	    		System.out.println("FAQ answer is still visible even after closing");
		    	test.fail("FAQ answer is still visible after closing");
		    	throw e;
	    	}		
	    }
	    @Test(priority=11)
	    public void FAQanswer() throws InterruptedException {
	    	...
	    	try {
	    		WebElement faquestion=driver.findElement(By.xpath("//h3[normalize-space()='What payment methods do you accept?']"));
		    	...
		    	test.pass("FAQ answer is visible after expanding");
	    	}catch(AssertionError e) {
	    		System.out.println("FAQ answer is not visible after expanding");
		    	test.fail("FAQ answer is not visible after expanding");
		    	throw e;
	    	}	
	    }
	    @Test(priority=12)
	    ...
	    public void testLinksNavigation() throws InterruptedException {
	        try {
	            ...
	            driver.findElement(By.xpath("//a[normalize-space()='Browse Courses']")).click();	// Browse Courses Link
	            Thread.sleep(2000);
	            ...
	            driver.findElement(By.xpath("//a[normalize-space()='View Workshops']")).click();	//View Workshops Link
	            Thread.sleep(2000);
	            ...
	            driver.findElement(By.xpath("//a[normalize-space()='Read Blog']")).click();	 //Read Blog Link
	            Thread.sleep(2000);
