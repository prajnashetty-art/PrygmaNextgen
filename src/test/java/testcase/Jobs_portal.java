...
public class Jobs_portal {
	...
	public void setup() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[normalize-space()='Unlock Your Career Potential']")));	
	}
	@Test(priority = 1)
    ...
    public void alllinks() {
	 ...
	 @Test(priority = 7)
	    public void testSearchBar() {
	        test=extent.createTest("Test Search bar");
	        try {
	        	 driver.findElement(By.xpath("//input[@placeholder='Job Title Or Keyword']")).sendKeys("developer");
	        	 driver.findElement(By.xpath("//button[normalize-space()='Find A Job']")).click();
	        	 JavascriptExecutor js=(JavascriptExecutor) driver;
	        	 js.executeScript("window.scrollBy(0,700)", "");
	        	 String pageSource = driver.getPageSource();
	 	        Assert.assertTrue(pageSource.contains("developer"));
	 	        System.out.println("Search bar works correctly and results are displayed.");
	 	    }catch (AssertionError e) {
	 	    	System.out.println("Search results did not contain expected keyword");
	 	    	test.fail("Search results did not contain expected keyword");
	        }
	 }     
	@AfterMethod()
