...
public class Blog {
	 ...
	 WebDriverWait wait;
	  ...
	  public void reportSetup(){
	      ...
	      spark = new ExtentSparkReporter(projectPath + "/Reports/Blog_Report.html");
	    ...
	    public void setup() throws InterruptedException {
	        ...
	        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(normalize-space(),'Blog')]")));
	    }
	    @Test(priority = 1)
	    ...
	    public void verifyExplorecoursesButton() throws InterruptedException {
	        ...
	        try {
	        	...
	        	System.out.println("Explore courses button does not navigates to Courses page");
		        test.fail("Explore courses button does not navigates to Courses page");
		        throw e;
	        }
